...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/optics_functions-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14616&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/optics_functions-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `optics_functions` can be installed with:

```
conda install optics_functions
```

It is possible to list all of the versions of `optics_functions` available on your platform with:
